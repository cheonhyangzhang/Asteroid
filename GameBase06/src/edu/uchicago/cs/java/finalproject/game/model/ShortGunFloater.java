...
public class ShortGunFloater extends Sprite{

		private int nSpin;

		public ShortGunFloater() {
			super();
		...
		public void draw(Graphics g) {
			...
			if (imgNewShip==null){
				try {
					imgNewShip = ImageIO.read(new File("src/edu/uchicago/cs/java/finalproject/images/shortGunFloater.png"));
				} catch (IOException e) {
				e.printStackTrace();
